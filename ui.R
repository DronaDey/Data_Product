...
shinyUI(navbarPage("Select the best car for your trip",
                   tabPanel("Table",
                            ...
                            sidebarLayout(
                              sidebarPanel(
                                helpText("Provide information about your trip and the details about the vehicle that you want"),
                                numericInput('dis', 'Distance (in miles):', 50, min = 1, max = 1000),
                                numericInput('cost', 'Petrol Price (per litre):', 2.41, min = 2, max = 4, step=0.01),
                                numericInput('petrol', 'Maximum expenditure on petrol:', 50, min=1, max=1000),
